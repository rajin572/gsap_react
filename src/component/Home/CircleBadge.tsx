...
const CircularBadge = () => {
    const text = "GET EDITED NOW • START YOUR FREE TRIAL • ";
    ...
    return (
        <div className="relative w-40 h-40 rounded-full bg-violet-900/10 backdrop-blur-sm  border-2 border-secondary/10 flex items-center justify-center">
                ...
                <div ref={ringRef} className="relative w-full h-full">
                    {text.split("").map((char, i) => {
                        ...
                        return (
                            <span
                                key={i}
                                className="absolute left-1/2 top-1/2 text-xs text-white"
                                style={{
            ...
            {/* Center Icon */}
            <div className="z-10 flex items-center justify-center w-25 h-25 rounded-full border-2 border-secondary/0">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" fill="none" viewBox="0 0 82 30">
